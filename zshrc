...
alias updatehyp='hyprpm update' #hyprland plugin updates
alias updateflat='flatpak update' # flatpak updates
alias updatedolphin='~/.scripts/update_dolphin_apps.sh' #uipdates doplhins app list
